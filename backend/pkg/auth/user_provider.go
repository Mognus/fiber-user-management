...
func (p *UserProvider) GetSchema() crud.Schema {
	...
	return crud.Schema{
		...
		Fields: []crud.Field{
			...
			{Name: "email", Type: "string", Label: "Email", Required: true, Width: "200px"},
			{Name: "password", Type: "string", Label: "Password", Required: true, EditHidden: true, Width: "180px"},
			{Name: "first_name", Type: "string", Label: "First Name", Width: "140px"},
			{Name: "last_name", Type: "string", Label: "Last Name", Width: "140px"},
			{Name: "role_id", Type: "relation", Label: "Role", Required: true, TableHidden: true, Options: roleOptions},
			{Name: "role", Type: "object", Label: "Role", Readonly: true, Width: "120px"},
			{Name: "active", Type: "boolean", Label: "Active", Width: "100px"},
